...
public class Data {
    ...
    public Data(Data data) throws Exception {
   ...
   public void setData(String s) throws Exception {
    ...
    public Data VerificaECriaData (int _dia,int _mes,int _ano){
        ...
        public int compareTo (Data dataComp) {
            if (dataComp.getAno()<this.getAno()){
                return 1;
            }
            else {
                if (this.getMes()>dataComp.getMes()) {
                    return 1;
                }
                else {
                    if (this.getDia()>dataComp.getDia()) {
                        return 1;
                    }
                }
            }
            if (this.getDia() == dataComp.getDia() && this.getMes() == dataComp.getMes() && this.getAno() == dataComp.getAno()) {
                return 0;
            }
            else {
                return -1;
