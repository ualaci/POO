...
public class Data {
   ...
   public void setData(String s) throws Exception {
    ...
    public void incrementa() throws Exception {// porque nao declara Data DataAIncrementar?
        try {
    ...
    public Data VerificaECriaData (int _dia,int _mes,int _ano){
        ...
        public static int compareTo (Data DataTeste) {
            Data data = UsoData.dataComp;
            ...
            if (DataTeste.getDia() == data.getDia() && DataTeste.getMes() == data.getMes() && data.getAno() == UsoData.dataComp.getAno()) {
                return 0;
            }
            else {
                return -1;
